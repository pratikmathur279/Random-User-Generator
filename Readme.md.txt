...
The serverless.yml contains the services getUser and retrieveUser which deploy the functions on AWS Lambda and the AWS API Gateway configures the REST API calls to the applications. 